...
import Grid from '@mui/material/Grid'; // Recomanat Grid2 per a millor responsive
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Grid container spacing={{ xs: 4, md: 8 }}>
            ...
            <Grid size={{ xs: 12, md: 5 }} sx={{ textAlign: { xs: 'center', md: 'left' } }}>
              ...
              <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.6, maxWidth: { xs: '300px', md: '380px' }, mx: { xs: 'auto', md: 'unset' }, fontSize: { xs: '0.9rem', md: '1.1rem' } }}>
          ...
          <Box sx={{ 
            ...
            <Typography sx={{ color: 'text.secondary', opacity: 0.6, fontSize: { xs: '0.7rem', md: '0.8rem' }, fontWeight: 600 }}>
